...
<form action="/pinjaman/insert" method="POST" enctype="multiparty/form-data">
    @csrf
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input name="id_pinjaman" class="form-control" value="{{ old('id_pinjaman') }}">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="date" name="tgl_pinjaman" class="form-control" required>
                    <div class="text-danger">
                        @error('tgl_pinjaman')
                        {{ $message }}
                        @enderror
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input name="lama_pinjaman" class="form-control" value="{{ old('lama_pinjaman') }}">
                    <div class="text-danger">
                        @error('lama_pinjaman')
                        {{ $message }}
                        @enderror
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label>BUNGA</label>
                    <input name="bunga" class="form-control" value="{{ old('bunga') }}">
                    <div class="text-danger">
                        @error('bunga')
                        {{ $message }}
                        @enderror
