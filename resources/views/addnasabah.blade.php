...
<form action="/nasabah/insert" method="POST" enctype="multiparty/form-data">
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input name="simpanan_pokok" class="form-control" value="{{ old('simpanan_pokok') }}">
                    <div class="text-danger">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input name="simpanan_wajib" class="form-control" value="{{ old('simpanan_wajib') }}">
                    <div class="text-danger">
